...
export class App extends LitElement {
	...
	async showHelpToast () {
		const {showSnackbar} = await import("./util/show-snackbar.js");
		showSnackbar(`Trilha da agilidade é um panorama de conhecimento e habilidades úteis para todo agilista`, {
			timeout: 1000 * 20,
			wide: true,
			buttons: [
				["Ler Mais", () => this.openHelp()],
				["Desconsiderar", () => ({})]
			]
		});
	}
			...
			<header id="header">
				...
				<div>
					...
					<a aria-label="autor" href="https://www.reynaldobarrosjr.com" target="_blank" rel="noopener" title="Dê um oi!">
						<ws-icon hoverable .template="${reynaldoAvatarTemplate}"></ws-icon>
					</a>
					<a id="coffee" aria-label="Buy coffee" href="#" rel="noopener" title="Support me <3" target="_blank">
